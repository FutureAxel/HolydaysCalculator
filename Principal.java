...
public class Principal extends JFrame implements ActionListener{
  ...
  public Principal(){
   ...
   labelBienvenido.setFont(new Font("Andale Mono", 1, 22));
   ...
   labelResultado = new JLabel("Resultado del cálcluo:");
   ...
   area1.setFont(new Font("Andale Moni", 1 , 11));
  ...
  public void actionPerformed(ActionEvent e){
   ...
   if(e.getSource() == miElCreador){
     JOptionPane.showMessageDialog(null,"Desarrollado por Axel Maidana, con ayuda de la Geekipedia");
   }
 }
